...
class BacktestingEngine:
    ...
    def __init__(self) -> None:
        ...
        self.strategy_class: Type[StockStrategyTemplate] = None
        self.strategy: StockStrategyTemplate = None
        self.tick: TickData
        self.bar: BarData
    ...
    def add_strategy(self, strategy_class: Type[StockStrategyTemplate], setting: dict) -> None:
        """"""
    ...
    def cancel_stop_order(self, strategy: StockStrategyTemplate, vt_orderid: str) -> None:
        """"""
    ...
    def cancel_limit_order(self, strategy: StockStrategyTemplate, vt_orderid: str) -> None:
        """"""
...
def evaluate(
    target_name: str,
    strategy_class: StockStrategyTemplate,
    vt_symbol: str,
    interval: Interval,
    start: datetime,
    rate: float,
