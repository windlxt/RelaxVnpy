...
from .template import StockStrategyTemplate
...
class CtaEngine(BaseEngine):
    ...
    def check_stop_order(self, tick: TickData) -> None:
        ...
        for stop_order in list(self.stop_orders.values()):
            ...
            if long_triggered or short_triggered:
                strategy: StockStrategyTemplate = self.strategies[stop_order.strategy_name]
    ...
    def send_server_order(
        self,
        strategy: StockStrategyTemplate,
    ...
    def cancel_server_order(self, strategy: StockStrategyTemplate, vt_orderid: str) -> None:
        """
    ...
    def cancel_local_stop_order(self, strategy: StockStrategyTemplate, stop_orderid: str) -> None:
        """
    ...
    def cancel_order(self, strategy: StockStrategyTemplate, vt_orderid: str) -> None:
        """
        """
    ...
    def cancel_all(self, strategy: StockStrategyTemplate) -> None:
        """
    ...
    def get_pricetick(self, strategy: StockStrategyTemplate) -> float:
        """
    ...
    def get_size(self, strategy: StockStrategyTemplate) -> int:
        """
    ...
    def call_strategy_func(
        self, strategy: StockStrategyTemplate, func: Callable, params: Any = None
    ) -> None:
        """
    ...
    def add_strategy(
        ...
        strategy_class: Optional[Type[StockStrategyTemplate]] = self.classes.get(class_name, None)
        ...
        strategy: StockStrategyTemplate = strategy_class(self, strategy_name, vt_symbol, setting)
    ...
    def _init_strategy(self, strategy_name: str) -> None:
        ...
        """
        strategy: StockStrategyTemplate = self.strategies[strategy_name]
    ...
    def sync_strategy_data(self, strategy: StockStrategyTemplate) -> None:
        """
    ...
    def get_strategy_class_parameters(self, class_name: str) -> dict:
        ...
        """
        strategy_class: Type[StockStrategyTemplate] = self.classes[class_name]
    ...
    def put_strategy_event(self, strategy: StockStrategyTemplate) -> None:
        """
    ...
    def write_log(self, msg: str, strategy: StockStrategyTemplate = None) -> None:
        """
    ...
    def send_email(self, msg: str, strategy: StockStrategyTemplate = None) -> None:
        """
