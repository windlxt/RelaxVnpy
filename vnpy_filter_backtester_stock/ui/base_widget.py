...
from vnpy_filter_backtester_stock.engine_copy import (
...
class BacktesterManager(QtWidgets.QWidget):
    ...
    def __init__(self, main_engine: MainEngine, event_engine: EventEngine) -> None:
        ...
        self.backtester_engine: BaseEngine = BacktesterEngine(self.main_engine, self.event_engine)
    ...
    def init_ui(self) -> None:
        ...
        for button in [
            ...
            # button.setFixedHeight(button.sizeHint().height() * 1)
        ...
        left_vbox_window = QtWidgets.QWidget()
        left_vbox_window.setFixedWidth(280)
        left_vbox_window.setStyleSheet("QWidget { border: 1px solid #505070;}")
        left_vbox_window.setLayout(left_vbox)
        ...
        left_hbox.addWidget(left_vbox_window)
...
if __name__ == '__main__':
    ...
    win = BacktesterManager(main_eng, eng)
    win.show()
    app.exec()
