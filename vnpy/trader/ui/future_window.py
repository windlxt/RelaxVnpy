...
class FutureWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self, main_engine, event_engine) -> None:
        ...
        self.window_title: str = f"VeighNa Trader 社区版 - {vnpy.__version__}   [{utility.TRADER_DIR}]"
    ...
    def init_menu(self) -> None:
        ...
        for name in gateway_names:
            ...
            self.add_action(
                sys_menu,
                f"连接{name}",
                utility.get_icon_path(__file__, "connect.ico"),
                func
            )
        ...
        self.add_action(
            sys_menu,
            "退出",
            utility.get_icon_path(__file__, "exit.ico"),
            self.close
        )
        ...
        all_apps: List[engine.BaseApp] = self.main_engine.get_all_apps()
        for app in all_apps:
        ...
        self.add_action(
            help_menu,
            "查询合约",
            utility.get_icon_path(__file__, "contract.ico"),
        ...
        self.add_action(
            help_menu,
            "还原窗口",
            utility.get_icon_path(__file__, "restore.ico"),
        ...
        self.add_action(
            help_menu,
            "测试邮件",
            utility.get_icon_path(__file__, "email.ico"),
        ...
        self.add_action(
            help_menu,
            "社区论坛",
            utility.get_icon_path(__file__, "forum.ico"),
            self.open_forum,
            True
        )
        ...
        self.add_action(
            help_menu,
            "关于",
            utility.get_icon_path(__file__, "about.ico"),
